...
#define d_game_title "game"
#define d_game_resources "./data"
#define d_game_resources_default_png    "./data/placeholders/default_png.png"
#define d_game_resources_default_ttf    "./data/placeholders/default_ttf.ttf"
#define d_game_resources_default_json   "./data/placeholders/default_json.json"
#define d_game_resources_default_ogg    "./data/placeholders/default_ogg.wav"
#define d_game_resources_default_lisp   "./data/placeholders/default_lisp.lisp"
#define d_game_resources_configuration  "./data/game_config.json"
#define d_game_resources_loading        "./data/images/loading_screen.png"
